export const KIND_FIELDS = {
  ...
  offshore_entity: [
    ...
    'address',
    'national_id',
    'offshore_entity_name',
    'offshore_jurisdiction',
    'offshore_jurisdiction_description',
    'offshore_status',
    'offshore_source',
    'offshore_service_provider',
    'offshore_incorporation_date',
    'offshore_inactivation_date',
    'offshore_struck_off_date',
    'offshore_relationship',
    'offshore_relationship_direction',
    'offshore_person_countries',
    'offshore_entity_countries',
  ],
  generic: ['person_name', 'address', 'phone', 'national_id'],
}
...
export const FIELD_LABELS = {
  ...
  offshore_entity_name: 'Offshore entity name',
  offshore_jurisdiction: 'Jurisdiction',
  offshore_jurisdiction_description: 'Jurisdiction description',
  offshore_status: 'Status',
  offshore_source: 'Source',
  offshore_service_provider: 'Service provider',
  offshore_incorporation_date: 'Incorporation date',
  offshore_inactivation_date: 'Inactivation date',
  offshore_struck_off_date: 'Struck off date',
  offshore_relationship: 'Relationship',
  offshore_relationship_direction: 'Relationship direction',
  offshore_person_countries: 'Person countries',
  offshore_entity_countries: 'Entity countries',
}

export const KIND_OPTIONS = ['tax', 'vehicle', 'utility', 'property', 'offshore_entity', 'generic']
...
export const BENFORD_EXPECTED = [0.301, 0.176, 0.125, 0.097, 0.079, 0.067, 0.058, 0.051, 0.046]
